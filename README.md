# x-ng4-http-interceptor-test

[![Travis branch](https://img.shields.io/travis/1tontech/x-ng4-http-interceptor-test/master.svg?style=flat-square)](https://img.shields.io/travis/1tontech/x-ng4-http-interceptor-test/master.svg)
[![version](https://img.shields.io/npm/v/x-ng4-http-interceptor-test.svg?style=flat-square)](http://npm.im/x-ng4-http-interceptor-test)
[![downloads](https://img.shields.io/npm/dm/x-ng4-http-interceptor-test.svg?style=flat-square)](http://npm-stat.com/charts.html?package=x-ng4-http-interceptor-test)
[![MIT License](https://img.shields.io/npm/l/x-ng4-http-interceptor-test.svg?style=flat-square)](http://opensource.org/licenses/MIT)
[![semantic-release](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079.svg?style=flat-square)](https://github.com/semantic-release/semantic-release)

This package adds the intercepting capabilities to `http` module of Latest version of Angular, by extending the @angular/http class. Demo for this project can be found [here](https://github.com/1tontech/x-ng4-http-interceptor-test-demo)
...
```
npm install x-ng4-http-interceptor-test --save
```
...
import { InterceptorService } from 'x-ng4-http-interceptor-test';
...
```ts
import { Interceptor, InterceptorRequest, InterceptorResponseWrapper } from 'x-ng4-http-interceptor-test';
